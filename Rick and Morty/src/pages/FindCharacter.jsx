...
export const FindCharacter = () => {
  ...
  const {character, info, isLoading } = UseFetchSearch( name, status, gender, counter);
  ...
  <IsLoading />
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
